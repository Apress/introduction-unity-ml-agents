...
{
    /// <summary>
    /// Component that wraps a <see cref="EcosystemRenderTextureSensor"/>.
    /// </summary>
    public class EcosystemRenderTextureSensorComponent : SensorComponent, IDisposable
    {
        EcosystemRenderTextureSensor m_Sensor;
        ...
        string m_SensorName = "EcosystemRenderTextureSensor";
        ...
        {
            Dispose();
            m_Sensor = new EcosystemRenderTextureSensor(RenderTexture, Grayscale, SensorName, m_Compression);
