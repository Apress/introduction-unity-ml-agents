...
{
    /// <summary>
    /// A modified version of the RenderTextureSensor from the ML-Agents Toolkit, designed for use with the Ecosystem sample.
    /// </summary>
    public class EcosystemRenderTextureSensor : ISensor, IBuiltInSensor, IDisposable
    {
        ...
        public EcosystemRenderTextureSensor(
        ...
        {
            byte[] observation = null;
            if (WorldObserver.GetCachedObservation(ref observation))
            {
                return observation;
            }
            ...
            WorldObserver.SetCachedObservation(compressed);
            return compressed;
        }
